...
static struct list_head connected_buffer_list;
static struct mutex list_lock;
extern void do_policy_kick(void);
...
extern void perfmgr_notifer_wq_hook(int cmd);
extern int perfmgr_notify_connect_cb(int pid,unsigned long long identifier,int connectedAPI);
